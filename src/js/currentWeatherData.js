...
export const currentWeatherData = async (data, key) => {
  ...
  if (data.lat && data.lon) {
    API_URL = `https://api.openweathermap.org/data/2.5/weather?lat=${data.lat}&lon=${data.lon}&appid=20c9339096c1e162a9cb23d3cf43223d&units=metric`;
  } else {
    API_URL = `https://api.openweathermap.org/data/2.5/weather?q=${data}&appid=20c9339096c1e162a9cb23d3cf43223d&units=metric`;
  }
